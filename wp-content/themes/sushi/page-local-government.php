<?php
/*
* Template Name: Local Government
*
* @package WordPress
* @subpackage Sushi
*/
								...
								<div class="single-post">
									...
									<?php 
										...
										$ctr = 0;
											...
											?>
											<div class="list local-<?php echo $ctr; ?>">
												<?php if ( has_post_thumbnail() ) :
													$image_id =	get_post_thumbnail_id( $post->ID );
													$image = wp_get_attachment_image_src( $image_id, 'full' );
												?>	
												<div class="img-wrap fL"><img src="<?php echo $image[0]; ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"></div>
												<?php endif; ?>
