...
<div id="mc_signup">
	<form method="post" action="#mc_signup" id="mc_signup_form">
		...
		<input type="hidden" id="mc_sushi_using_placeholder" name="mc_sushi_using_placeholder" value="<?php echo get_option( 'mc_use_sushi_placeholder' ); ?>" />
		<input type="hidden" id="mc_sushi_using_pretag" name="mc_sushi_using_pretag" value="<?php echo get_option( 'mc_use_sushi_pretag' ); ?>" />
...
function mailchimp_form_field($var, $num_fields) {
	...
	$sushi_use_ph = get_option( 'mc_use_sushi_placeholder' );	
	$sushi_ph = ( $sushi_use_ph == 'on' ) ? 'placeholder="' . esc_html( $var['name'] ) . '"' : '';
	// End Sushi
